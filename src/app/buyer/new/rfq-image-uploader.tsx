  ...
  return (
    <div className="rounded-none border border-dashed border-slate-300 bg-slate-50 p-4">
      <div className="flex items-start gap-3">
        ...
        <div><p className="text-sm font-semibold text-slate-800">Add a reference image <span className="font-normal text-slate-400">(optional)</span></p><p className="mt-1 text-xs text-slate-500">JPG, PNG, or WebP. We resize it to 1200px, then upload it securely after publishing.</p></div>
      </div>
